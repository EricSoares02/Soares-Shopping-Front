import { BagComponent } from "./bag.style";
...
export default function BagIcon(prop: PropType) {
  return (
    <BagComponent $bagSize={prop.size}>
      <svg
        version="1.0"
      ...
      >
        ...
        >
          <path
            d="M2406 5110 c-259 -41 -504 -178 -662 -372 -147 -179 -226 -376 -249
